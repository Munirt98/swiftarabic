...
$string['cocoon_course_categories_4:addinstance'] = 'Add a new courses block';
$string['cocoon_course_categories_4:myaddinstance'] = 'Add a new courses block to Dashboard';
$string['hideallcourseslink'] = 'Hide \'All courses\' link';
$string['owncourses'] = 'Admin user sees own courses';
$string['pluginname'] = '[Edu101] Course categories 4.1 (Dark)';
$string['privacy:metadata'] = 'The Edu101 Courses block only shows data about courses and does not store any data itself.';
